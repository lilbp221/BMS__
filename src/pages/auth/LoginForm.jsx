...
{/* DYNAMIC INPUT USING PROPS */}
   ...
   { type === 'REGISTER' &&(  <div className="relative">
                                    <input autocomplete="off" id="username" name="username" type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="User Name" />
						...
						<div className=" flex">
							<button className="bg-blue-500 text-white rounded-md px-2 py-1 flex-grow">Submit</button>
						</div>
					</div>
				</div>
			</div>
