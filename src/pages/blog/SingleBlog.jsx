...
const SingleBlog = () => {
  ...
  //deleting blog with delete button
            ...
            <div className="md:flex-1 px-4">
              ...
              <div className="flex -mx-2 mb-4">
                ...
                <Link to={`/blogs/edit/${blog._id}`}>
                  <div className="w-1/2 px-2">
                    <button className="w-20 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white py-2 px-4 rounded-full font-bold hover:bg-gray-300 dark:hover:bg-gray-600 "
                    onClick={`/blogs/${blog._id}`}
                    >
                      Edit
              ...
              <Link to="/">
                <div className="px-2">
                  <div className="flex justify-end mt-20">
                    <button className="w-30 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white py-2 px-4 rounded-full font-bold hover:bg-gray-300 dark:hover:bg-gray-600 flex ">
                      Home
                    </button>
                  </div>
                </div>
